/* ============================================================
   Digital Electronics MCQ — App (Cybersecurity Engineering)
   ============================================================ */
...
const STORE = {
    ...
    AUTH:     'decyber.auth',
    STATS:    'decyber.stats',
    ACTIVE:   'decyber.activeQuiz',     // resume mid-quiz
    ATTEMPTS: 'decyber.examAttempts',   // per-student exam-mode lockout
};
        ...
        if (mixedBtn) {
            ...
            mixedBtn.textContent = !windowOpen && mode === 'exam'
                ...
                : attempted && mode === 'exam'
                    ...
                    : `▶ Start mixed (all ${state.questions.length})`;
        }
    };
